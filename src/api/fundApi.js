 ...
 */
export const getFundBalance = async (userId, options = {}) => {
  const response = await fetch(`${API_BASE_URL}/api/funds/${userId}`, options);
 ...
 */
export const getFundLogs = async (userId, options = {}) => {
  const response = await fetch(`${API_BASE_URL}/api/funds/${userId}/logs`, options);

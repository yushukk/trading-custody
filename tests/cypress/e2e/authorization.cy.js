describe('Authorization and Access Control', () => {
  ...
  describe('Regular User Access Control', () => {
    ...
    it('should verify regular user has valid session cookies', () => {
      // Verify cookies are set (HttpOnly cookies exist)
      cy.getCookie('accessToken').should('exist');
      cy.getCookie('refreshToken').should('exist');

      // Verify localStorage does NOT contain sensitive auth data
  ...
  describe('Admin User Access Control', () => {
    ...
    it('should verify admin has valid session cookies', () => {
      // Verify cookies are set (HttpOnly cookies exist)
      cy.getCookie('accessToken').should('exist');
      cy.getCookie('refreshToken').should('exist');
